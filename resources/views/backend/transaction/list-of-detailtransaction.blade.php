...
<div class="ibox">
    <div class="ibox-head">
        ...
        <span class="pull-right" ><i class="fa fa-info-circle"></i> Detail Transactions</span>
    </div>
    ...
    @endif
    <div class="ibox-body">
        <h1 class="font-strong mb-4">Detail Transaction</h1>
...
@section('custom-js')
    <script>
        $(document).ready(function() {
            ...
            var url = "{{ route('transaction.detail', ['id' => ':id'] )}}";

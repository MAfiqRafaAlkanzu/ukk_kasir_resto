                ...
                <div class="ibox-body">
                    <form action="{{ route('transaction.insert_new') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-4 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control @error('user') is-invalid @enderror" type="text" placeholder="Customer Name" value="{{ auth()->user()->name }}" name="user" required>
                                @error('user')
                        ...
                        <div class="form-group mb-4 row">
                            <label class="col-sm-2 col-form-label" for="seat_number">Table Number</label>
                            <div class="col-sm-10">
                                <select class="form-control @error('seat_number') is-invalid @enderror" name="seat_number">
                        ...
                        <div class="form-group mb-4 row">
                            ...
                            <div class="col-sm-10">
                                <select class="select2_demo_2 form-control @error('menu') is-invalid @enderror" name="menu[]" multiple="">

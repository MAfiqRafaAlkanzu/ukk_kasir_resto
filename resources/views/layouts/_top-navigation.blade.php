...
<ul class="nav navbar-toolbar">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-media">
            ...
            <div class="p-3">
                <div class="media-list media-list-divider scroller" data-height="350px" data-color="#71808f">
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u8.jpg" alt="image" />
                        </div>
                    ...
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u6.jpg" alt="image" />
                        </div>
                        <div class="media-body">
                    ...
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u11.jpg" alt="image" />
                        </div>
                        <div class="media-body">
                    ...
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u10.jpg" alt="image" />
                        </div>
                        <div class="media-body">
                    ...
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u2.jpg" alt="image" />
                        </div>
                        <div class="media-body">
                    ...
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u5.jpg" alt="image" />
                        </div>
                        <div class="media-body">
                    ...
                    <a class="media p-3">
                        <div class="media-img">
                            <img class="img-circle" src="{{ asset('backend') }}/assets/img/users/u9.jpg" alt="image" />
                        </div>
                        <div class="media-body">
    ...
    <li class="dropdown dropdown-user">
        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
            ...
            <img src="{{ asset('backend') }}/assets/img/users/admin-image.png" alt="image" />
        </a>
